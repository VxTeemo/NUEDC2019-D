...
void Touch_Handle(double data)
{
	  ...
	  /****          频率设置选择               ****/
		...
		if(data !=0 )//参数值改变
		{
				switch(SetChoose)
				{
					case 0: Out_Freq=data; ADF4351WriteFreq(Out_Freq+(u16)(Out_Freq/100.0f)/1000.0f);break;  //匹配晶振误差 Divisor=-0.0000009599f*pow(Out_Freq,3)+0.0006239*pow(Out_Freq,2)-0.118*Out_Freq+34.61;
					
					case 1: Step_Freq=data;break;
					
					case 2: Start_Freq=data;break;
					
					case 3: Stop_Freq=data;break;
					
					case 4: Sweep_Time=data;break;
					
					case 5: Wave_Vol=data;if(Wave_Vol>70)Wave_Vol+=1;break;
				}
				Start_Meum();
		...
		switch(SetChoose)
		{
			case 0: OS_Rect_Draw(200,25,450,70,1,Red);  break;
		
			case 1: OS_Rect_Draw(200,85,450,130,1,Red);  break;
		
			case 2: OS_Rect_Draw(200,145,450,190,1,Red);  break;
		
			case 3: OS_Rect_Draw(200,205,450,250,1,Red);  break;
		
			case 4: OS_Rect_Draw(200,265,450,310,1,Red);  break;
		
			case 5: OS_Rect_Draw(200,325,450,370,1,Red);  break;
		}
